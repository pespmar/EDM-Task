...
missingdatamethods = c('None' , 'Interpolation' , 'Mean')
...
COMPLETESLICE = na.omit(COMPLETE) %>% sample_n(size = 1000)
```
  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "exploratory",
              ...
              selectInput("selectNA", "Select one Station to check missing data:",                    choices =  opciones),
...
plot_selected <- switch(input$missingdata,
                        'None' = graficosPMporDia[[input$selectNA]],
                        'Interpolation' =graficosPMporDiaInterpolacion[[input$selectNA]],
                        'Mean' = graficosPMporDiaMedia[[input$selectNA]])
